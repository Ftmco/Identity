...
namespace Identity.DataBase.Context.Migrations
{
    ...
    [Migration("20220609162142_PageAction")]
    partial class PageAction
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Identity.DataBase.Entity.ActionsRoles", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Identity.DataBase.Entity.PageAction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Identity.DataBase.Entity.ActionsRoles", b =>
                {
                    b.HasOne("Identity.DataBase.Entity.ActionsRoles", "ActionsRole")
                        .WithMany()
                        .HasForeignKey("ActionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Identity.DataBase.Entity.PageAction", null)
